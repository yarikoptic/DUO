...
- The term 'consent code primary category' and 'secondary category' have been deprecated: they were not used to tag datasets but instead as patterns for DUO codes capture. Those patterns are institute specific and would be better reflected by Schemablocks constraints specific to a repository.
